...
import { KeyEnum } from '../utils/KeyEnum'
import {
  ShouldRenderSuggestionFn as ShouldRenderSuggestionFn,
...
export class InlineSuggest<T> extends React.Component<Props<T>, State> {
  ...
  private handleOnChange: TextFieldProps['onChange'] = (e) => {
  ...
  private handleOnKeyDown: TextFieldProps['onKeyDown'] = (e) => {
  ...
  private handleOnKeyUp: TextFieldProps['onKeyUp'] = (e) => {
    const { keyCode } = e
